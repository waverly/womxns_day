  ...
  _createClass(MyApp, [{
    ...
    value: function componentDidMount() {
      ...
      if (typeof window === "undefined") {
        ...
        if (hash !== "") {
          var id = hash.substr(1); // const elScrollHeight = document.getElementById(id).offsetTop;

          var elScrollHeight = 1000;
          ...
          if (elScrollHeight) {// window.scrollTo(0, elScrollHeight);
            // window.scrollTo({
            //   top: 1000,
            //   left: 0,
            //   behavior: "smooth"
...
//# sourceMappingURL=_app.js.1a2b3b0436e139ddec8e.hot-update.js.map