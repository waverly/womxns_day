...
function (_App) {
  ...
  _createClass(MyApp, [{
    ...
    value: function componentDidMount() {
      ...
      window && (typeof window === "undefined" ? "undefined" : _typeof(window)) === "object" && window.scrollTo && typeof window.scrollTo === "function" && window.scrollTo(2000, 2000); // if (typeof window === "undefined") {
      //   return 0;
      ...
      //     if (elScrollHeight) {
      //       console.log("there is el scrollHeight and it is ", elScrollHeight);
      //       window.scrollTo(elScrollHeight, 0);
      //     }
      //     const elOne = document.getElementById("TonyaHarding13").offsetTop;
      //     const elTwo = document.getElementById("GOD9").offsetTop;
...
//# sourceMappingURL=_app.js.c6c6774a966637344d19.hot-update.js.map