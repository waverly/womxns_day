          ...
          return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_styles_Form__WEBPACK_IMPORTED_MODULE_7__["default"], {
            ...
            function () {
              ...
              _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee(e) {
                var name, totalRes, _ref3, data, res, _totalRes;

                return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        e.preventDefault(); // without refreshing page, the list of names does not refresh
                      ...
                      case 9:
                        ...
                        console.log("not adding to db"); // Router.push(`/names#${this.state.slug}`);
                      ...
                      case 24:
                        ...
                        console.log(_totalRes.data); // Router.push(`/names#${this.state.slug}`);
...
//# sourceMappingURL=addname.js.b720ef95433ea47bad50.hot-update.js.map