...
function (_Component) {
  ...
  function WomenList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_debounceSetBodyHeight", lodash__WEBPACK_IMPORTED_MODULE_2__["debounce"](_helpers__WEBPACK_IMPORTED_MODULE_4__["setBodyHeight"], 100));
  ...
  _createClass(WomenList, [{
    ...
    value: function componentDidMount() {
      ...
      window.addEventListener("resize", _debounceSetBodyHeight);
      this.setState({
    ...
    //   if (this.props.isMobile < 768) {
    //     console.log("we are now on a mobile device");
    //   }
    // }
...
//# sourceMappingURL=names.js.d9bf77314b8d8a8390c2.hot-update.js.map