...
var setBodyHeight = function setBodyHeight() {
  if (typeof window === "undefined") {
    ...
    if (document.getElementById("womanList")) {
      var womanListHeight = document.getElementById("womanList").scrollHeight; // document.body.style.height =
      //   womanListHeight + womanListHeight * 0.05 + "px";

      document.body.style.height = womanListHeight + 400 + "px";
      console.log("inside of set body height", womanListHeight);
    }
  }
};
...
//# sourceMappingURL=names.js.3315969eddf8ba0cca28.hot-update.js.map