...
})(["height:calc(100vh / 3);overflow:hidden;-webkit-box-sizing:border-box;box-sizing:border-box;background:black;position:relative;&:first-of-type{&:before{content:\"\";position:absolute;top:0;left:0;display:block;width:100%;height:100px;background:-webkit-gradient( linear,left top,left bottom,from(rgba(0,0,0,1)),to(rgba(17,17,17,0)) );background:-webkit-linear-gradient( top,rgba(0,0,0,1),rgba(17,17,17,0) );background:-o-linear-gradient( top,rgba(0,0,0,1),rgba(17,17,17,0) );background:linear-gradient( to bottom,rgba(0,0,0,1),rgba(17,17,17,0) );z-index:20;-webkit-backface-visibility:hidden;backface-visibility:hidden;}}&:last-of-type{&:after{content:\"\";position:absolute;bottom:0;left:0;display:block;width:100%;height:100px;background:-webkit-gradient( linear,left top,left bottom,from(rgba(0,0,0,0.8)),to(rgba(17,17,17,0)) );background:-webkit-linear-gradient( top,rgba(17,17,17,0),rgba(0,0,0,0.8) );background:-o-linear-gradient( top,rgba(17,17,17,0),rgba(0,0,0,0.8) );background:linear-gradient( to bottom,rgba(17,17,17,0),rgba(0,0,0,0.8) );z-index:20;-webkit-backface-visibility:hidden;backface-visibility:hidden;}}"]);
...
//# sourceMappingURL=index.js.be9352119d1ac8dc77ec.hot-update.js.map