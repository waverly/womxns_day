  ...
  _createClass(MyApp, [{
    ...
    value: function componentDidMount() {
      ...
      if (typeof window === "undefined") {
        ...
        if (hash !== "") {
          var elScrollHeight = document.querySelector(hash).offsetTop;
          ...
          var elOne = document.getElementById("TonyaHarding13").offsetTop;
          var elTwo = document.getElementById("GOD9").offsetTop;
          console.log({
            elOne: elOne,
            elTwo: elTwo
          });
...
//# sourceMappingURL=_app.js.e9bc58fb1755367fb84d.hot-update.js.map