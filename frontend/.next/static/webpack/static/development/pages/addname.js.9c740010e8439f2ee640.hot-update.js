...
function (_Component) {
  ...
  function WomenList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "state", {
      scrollTop: 0,
      newlyAddedItem: null // scrollUpdatedOnLoad: false
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_scrollToHash", function () {
      ...
      if (typeof window === "undefined") {
        ...
        if (hash !== "") {
          ...
          var scrollEl = document.querySelector("[data-nameid=".concat(id, "]")); // const elScrollHeight = document.querySelector(`[data-nameid=${id}]`)
          //   .offsetTop;

          var womenWrapper = document.getElementById("womanList");
          console.log(womenWrapper);
          console.log(scrollEll);
          console.log(womenWrapper.lastChild);
          debugger;
  ...
  _createClass(WomenList, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {// if a new woman has been added
...
//# sourceMappingURL=addname.js.9c740010e8439f2ee640.hot-update.js.map