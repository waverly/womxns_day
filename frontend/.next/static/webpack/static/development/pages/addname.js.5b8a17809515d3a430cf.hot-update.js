...
function (_Component) {
  ...
  function WomenList() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_addHighlightClass", function (e) {
      ...
      console.log(e);
      console.log(e.currentTarget); // extract data-nameid

      var dataId = e.currentTarget.getAttribute("[data-nameid]");
      console.log(dataId);
      e.currentTarget.classList.add("highlighted"); // el.classList.addClass("highlighted");
    });
...
//# sourceMappingURL=addname.js.5b8a17809515d3a430cf.hot-update.js.map