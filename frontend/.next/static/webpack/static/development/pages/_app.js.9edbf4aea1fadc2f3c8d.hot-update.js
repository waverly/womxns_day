  ...
  _createClass(MyApp, [{
    ...
    value: function componentDidMount() {
      ...
      if (typeof window === "undefined") {
        ...
        if (hash !== "") {
          var elScrollHeight = document.querySelector(hash).offsetTop + 100;
          var halfHeight = window.innerHeight / 2.5;
          var newHeight = elScrollHeight - 200;
          console.log({
          ...
          if (elScrollHeight) {
            console.log("there is el scrollHeight and it is ", newHeight);
...
//# sourceMappingURL=_app.js.9edbf4aea1fadc2f3c8d.hot-update.js.map