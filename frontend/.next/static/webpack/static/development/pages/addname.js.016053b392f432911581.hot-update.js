    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_scrollToHash", function () {
      ...
      if (typeof window === "undefined") {
        ...
        if (hash !== "") {
          ...
          var scrollEl = document.querySelector("[data-nameid=".concat(id, "]")); // const elScrollHeight = scrollEl.offsetTop;

          var womenWrapper = document.getElementById("womanList");
          console.log(womenWrapper);
          console.log(scrollEl); // console.log(elScrollHeight);
...
//# sourceMappingURL=addname.js.016053b392f432911581.hot-update.js.map