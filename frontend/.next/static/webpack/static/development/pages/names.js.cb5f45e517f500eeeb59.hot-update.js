...
function (_Component) {
  ...
  _createClass(Women, [{
    ...
    value: function getDerivedStateFromProps(props, state) {
      var names = props.women;

      if (this.state.isMobile) {
        names = names.slice(0, 20); // console.log("is mobile", names);
...
//# sourceMappingURL=names.js.cb5f45e517f500eeeb59.hot-update.js.map