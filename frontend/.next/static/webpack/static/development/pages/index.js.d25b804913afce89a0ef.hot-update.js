  ...
  _createClass(WomenList, [{
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      if (prevProps.women.length !== this.props.women.length) {
        ...
        var newElId = document.getElementById("womanList").querySelector(".hidden").lastChild.dataset.nameid;
...
//# sourceMappingURL=index.js.d25b804913afce89a0ef.hot-update.js.map