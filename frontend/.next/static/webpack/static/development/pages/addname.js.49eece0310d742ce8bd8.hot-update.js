...
var _onShareClick = function _onShareClick(e) {
  ...
  var link = "".concat(domain, "/names#").concat(id); // const dummy = document.createElement("input");

  var dummy = document.body.createTextRange();
  dummy.moveToElementText(link);
  dummy.select();
...
//# sourceMappingURL=addname.js.49eece0310d742ce8bd8.hot-update.js.map