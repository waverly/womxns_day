    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_scrollToHash", function () {
      ...
      if (typeof window === "undefined") {
        ...
        if (hash !== "") {
          ...
          var scrollEl = document.querySelector("[data-nameid=".concat(_id, "]"));
          ...
          if (scrollEl) {
            ...
            document.querySelectorAll(".".concat(_id)).forEach(function (el) {
...
//# sourceMappingURL=addname.js.631d95673170af5f8b7e.hot-update.js.map