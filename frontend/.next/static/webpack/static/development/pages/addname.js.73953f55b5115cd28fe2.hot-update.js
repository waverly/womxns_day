...
function (_Component) {
      ...
      if (!_this.state.scrollUpdatedOnLoad) {
        ...
        if (typeof window === "undefined") {
          ...
          if (hash !== "") {
            ...
            var elScrollHeight;
            elScrollHeight = document.querySelector("[data-nameid=".concat(id, "]"));
  ...
  _createClass(WomenList, [{
    ...
    value: function componentDidMount() {
      Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["setBodyHeight"])(); // this._scrollToHash();
    ...
    value: function componentDidUpdate(prevProps, prevState) {
      ...
      if (prevProps.women.length !== this.props.women.length) {
        ...
        Object(_helpers__WEBPACK_IMPORTED_MODULE_4__["setBodyHeight"])(); // const newEl = document
...
//# sourceMappingURL=addname.js.73953f55b5115cd28fe2.hot-update.js.map