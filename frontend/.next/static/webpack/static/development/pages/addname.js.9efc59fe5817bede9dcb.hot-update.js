...
function (_Component) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_scrollToHash", function () {
      ...
      if (typeof window === "undefined") {
        ...
        if (hash !== "") {
          ...
          var womenWrapper = document.getElementById("womanList"); // debugger;
  ...
  _createClass(WomenList, [{
    ...
    value: function render() {
      console.log("has re-rendered with new name");
...
//# sourceMappingURL=addname.js.9efc59fe5817bede9dcb.hot-update.js.map