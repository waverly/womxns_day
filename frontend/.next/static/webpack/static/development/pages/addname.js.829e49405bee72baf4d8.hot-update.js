...
function (_Component) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "_scrollToHash", function () {
      ...
      if (typeof window === "undefined") {
        ...
        if (hash !== "") {
          ...
          var scrollEl = document.querySelector("[data-nameid=\"jenny\"]");
          console.log(womenWrapper);
          console.log(scrollEl);
          console.log(womenWrapper);
          setTimeout(function () {
            var timeoutscrollel = document.querySelector("[data-nameid=\"jenny\"]");
  ...
  _createClass(WomenList, [{
    ...
    value: function componentWillMount() {
      ...
      console.log(this.props.women[this.props.women.length - 1]); // this._scrollToHash();
    }
  }, {
...
//# sourceMappingURL=addname.js.829e49405bee72baf4d8.hot-update.js.map